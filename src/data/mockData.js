...
export const friendRows = [
  ...
  { name: "看雪落下的声音", state: "粉丝", detail: "对方关注了你，可以回关成为好友" },
];

export const pageCopy = {
  主页: ["主页", "珞珈山下，每个人都在写自己的故事。"],
  社交圈: ["社交圈", "关注是欣赏，好友是双向的奔赴。"],
  频道: ["频道", "有些圈子向所有人敞开，有些只需一个暗号。"],
  聊天: ["聊天", "和好友的悄悄话，和一群人的热闹，都在这里。"],
  我的主页: ["我的主页", "你的珞珈名片，你写下的每一天。"],
  收藏: ["我的收藏", "收藏过的好内容，随时回来翻翻。"],
    设置: ["设置", "定制你的圈子边界和颜色偏好。"],
    通知: ["通知", "点赞、评论、收藏和频道管理消息。"],
    全站管理: ["全站管理", "账号、频道和内容治理。"],
  频道详情: ["频道详情", "频道内部交流与活动空间。"],
  用户主页: ["用户主页", "看看 ta 在珞珈山的日常。"],
};
